...
class MyIdentification extends StatefulWidget {
  @override
  _MyIdentification createState() => _MyIdentification();
}

class _MyIdentification extends State<MyIdentification> {
                          ...
                          setState(() {
                            if (connectionStatus) {
                              Constants.personne = ModelPersonne(
                                ...
                                tel:
                                    "${idPays ? null : "".trim()}${tel.text.trim()}",
                                email: mail.text,
                                refType: type.text,
                              ...
                              if (isFieldtest() == true) {
                                BlocProvider.of<BlocPersonne>(context).add(
                                    EventePersonneSave(
